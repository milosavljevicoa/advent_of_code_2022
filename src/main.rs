...
fn main() {
    ...
    println!("Result of day two, part one: {:?}", day_three::part_one(true));
    println!("Result of day two, part one: {:?}", day_three::part_one(false));
    println!("Result of day two, part two: {:?}", day_three::part_two(true));
    println!("Result of day two, part two: {:?}", day_three::part_two(false));
}
